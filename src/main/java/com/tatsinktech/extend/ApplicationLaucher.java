...
import com.tatsinktech.process.thread.register.ExtendProcess;
...
public class ApplicationLaucher implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        int extend_maxRecord = Integer.parseInt(commonConfig.getApplicationExtendMaxRegRecord());
        ...
        ExecutorService process_Execute_extend = Executors.newFixedThreadPool(extend_pool);
