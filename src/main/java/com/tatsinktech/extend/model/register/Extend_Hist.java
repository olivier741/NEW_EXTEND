...
@NoArgsConstructor
@ToString
@Table(name = "extend_hist",
        indexes = {
            @Index(columnList = "msisdn", name = "msisdn_extend_idx")
            ,
                @Index(columnList = "transaction_id", name = "transaction_extend_idx")
        })
public class Extend_Hist extends AbstractModel<Long> {
